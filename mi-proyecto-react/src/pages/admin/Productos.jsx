...
const ProductosPage = () => {
  ...
  // 👇 ESTADOS PARA TALLAS Y COLORES (importados de data.js)
  ...
  useEffect(() => {
    const mappedProducts = initialProducts.map((p, i) => ({
      id: p.id || `prod-${i + 1}`,
      // 🔽 AQUÍ ASEGURAMOS QUE 'activo' SEA UN BOOLEANO
    ...
    // 👇 CARGAR TODOS LOS COLORES desde initialColors
  ...
  // ====== MANEJO DE IMÁGENES CON CARRUSEL ======
  ...
  const handleToggleStatus = (producto) => {
    ...
    setProductos((prev) => {
      ...
      console.log("Productos después del toggle:", nuevosProductos);
  ...
  const renderImageUpload = () => {
    ...
    return (
      <div>
        ...
        {/* Preview de imágenes con carrusel */}
        {images.length > 0 && (
          <div style={{
            position: 'relative',
            width: '100%',
      ...
      <AdminLayoutClean>
        ...
        >
          ...
          <div style={{ marginBottom: "8px" }}>
            ...
            {/* BUSCADOR Y FILTRO EN MISMO RENGLÓN */}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {/* 🔽 AQUÍ ESTÁ LA LLAMADA CORRECTA A EntityTable */}
                  <EntityTable
                    entities={paginated}
                    columns={columns}
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              {modalState.mode === "view" ? (
                renderField("Descripción", "descripcion", "text", [], "Descripción del producto...")
              ) : (
                <div>
                  <label style={{
                    fontSize: "12px",
